...
run_test_() ->
    ...
    [
        ...
        , ?_assertEqual([{Id2,0},{Id2,1},{Id2,0},{Id2,2},{Id2,0}], lists:reverse(Rt2#ebt_rt.tracing))

        , ?_assertEqual(?FAILURE, Rt3#ebt_rt.result)
        , ?_assertEqual([{Id3,0},{Id3,1},{Id3,0},{Id3,2},{Id3,0}], lists:reverse(Rt3#ebt_rt.tracing))

        , ?_assertEqual(?SUCCESS, Rt4#ebt_rt.result)
        , ?_assertEqual([{Id4,0},{Id4,1},{Id4,0}], lists:reverse(Rt4#ebt_rt.tracing))
    ].
